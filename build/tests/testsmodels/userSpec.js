...
describe('User Module', function () {
    describe('Test methods exists', function () {
        it('should have a Get Many Users method', function () {
        ...
        it('should have an Update User method', function () {
    ...
    describe('Test User Module Logic', function () {
        var user = {
            email: 'hi@gmail.com',
            first_name: 'Amani',
            last_name: 'Atiah',
        ...
        it('Get One  method should return testUser when  called ID', function () { return __awaiter(void 0, void 0, void 0, function () {
            var returnedUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
