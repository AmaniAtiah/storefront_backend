...
describe('Authentication Module', function () {
    describe('Test methods exists', function () {
        it('should have an authenticate User Module', function () {
...
describe('Test Authentication Logic', function () {
    ...
    it('Authenticated method should return the authenticated user', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('Authenticate method should return null for wrong credentials', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, userModel.authenticate('mohammed@gmail.com', 'fake-password')];
                case 1:
                    authenticatedUser = _a.sent();
