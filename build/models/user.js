...
var hashPassword = function (password) {
    var salt = parseInt(saltRounds, 10);
...
var UserModel = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, connection.query(sql, [u.email, u.first_name, u.last_name, hashPassword(u.password)])];
                    case 2:
                        result = _a.sent();
                        connection.release();
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Unable to create user (".concat(u.first_name, "): ").concat(error_1.message));
    ...
    UserModel.prototype.authenticate = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, result, hashPassword_1, isPasswordValid, userInfo, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 2:
                        ...
                        isPasswordValid = bcrypt_1.default.compareSync("".concat(password).concat(pepper), hashPassword_1);
                    ...
                    case 5:
                        error_2 = _a.sent();
                        throw new Error("Unable to login: ".concat(error_2.message));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Error at retriving users  ".concat(error_3.message));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        throw new Error("could not find user ".concat(id, ",  ").concat(error_4.message));
                    case 4: return [2 /*return*/];
                }
            });
        });
